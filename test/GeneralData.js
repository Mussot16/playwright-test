...
(async () => {
    try{
        ...
        await page.waitForSelector('input#matri', { state: 'visible' });
        const matriculaVisible = await page.locator('input#matri').isVisible();
        console.log(' Matrícula visible:', matriculaVisible);
        await page.waitForSelector('input#nombreAlumno', { state: 'visible' });
        const nombreVisible = await page.locator('input#nombreAlumno').isVisible();
        console.log(' Nombre visible:', nombreVisible);
